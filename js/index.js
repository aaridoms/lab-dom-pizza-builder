...
function renderButtons() {
  ...
  const aButtons = document.querySelectorAll(".btn");

  aButtons.forEach((eachElement) => {
    // Solucion para no hacer tantos if
    eachElement.onclick = function() {
...
function renderPrice() {
  ...
  // let activeButtons = document.querySelectorAll(".btn.active");
  // let pricesPanel = document.querySelectorAll(".panel .price")
  // console.log(pricesPanel)

  // activeButtons.forEach((eachButtons) => {

  // })

  // console.log(activeButtons)

  // ! No me ha dado tiempo a terminarlo pero lo terminare.
}
